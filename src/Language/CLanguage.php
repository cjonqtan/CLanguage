...
class CLanguage
{
    ...
    public function getDefault($key)
    {
        ...
        if (isset($key, $this->options) && $key != 'lang') {
            return file_get_contents($this->options['default'][$key]);
        } else if (isset($key, $this->options)) {
    ...
    {
        if ($lang != null && isset($this->options['meta'][$lang][$key])) {
            return $this->options['meta'][$lang][$key];
        } else if (isset($this->options['meta'][$this->getLang()][$key])) {
